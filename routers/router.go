...
func init() {
	...
	beego.SetStaticPath("/orange/Teacher/ProblemModelShow/css", `views/css`)
	beego.SetStaticPath("/orange/Teacher/ProblemModelShow/images", `views/images`)
	beego.SetStaticPath("/orange/Teacher/ProblemModelShow/js", `views/js`)
	beego.SetStaticPath("/orange/Teacher/ProblemModelShow/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Teacher/ProblemModelShow/b/js", `views/b/js`)
	...
	beego.SetStaticPath("/orange/Main/TechnoRegister/css", `views/css`)
	beego.SetStaticPath("/orange/Main/TechnoRegister/images", `views/images`)
	beego.SetStaticPath("/orange/Main/TechnoRegister/js", `views/js`)
	beego.SetStaticPath("/orange/Main/TechnoRegister/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Main/TechnoRegister/b/js", `views/b/js`)
	...
	beego.SetStaticPath("/orange/Main/PayMentUser/css", `views/css`)
	beego.SetStaticPath("/orange/Main/PayMentUser/images", `views/images`)
	beego.SetStaticPath("/orange/Main/PayMentUser/js", `views/js`)
	beego.SetStaticPath("/orange/Main/PayMentUser/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Main/PayMentUser/b/js", `views/b/js`)
	beego.SetStaticPath("/orange/Main/PayEnd/css", `views/css`)
	beego.SetStaticPath("/orange/Main/PayEnd/images", `views/images`)
	beego.SetStaticPath("/orange/Main/PayEnd/js", `views/js`)
	beego.SetStaticPath("/orange/Main/PayEnd/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Main/PayEnd/b/js", `views/b/js`)
	beego.SetStaticPath("/orange/Main/PayEndNotify/css", `views/css`)
	beego.SetStaticPath("/orange/Main/PayEndNotify/images", `views/images`)
	beego.SetStaticPath("/orange/Main/PayEndNotify/js", `views/js`)
	beego.SetStaticPath("/orange/Main/PayEndNotify/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Main/PayEndNotify/b/js", `views/b/js`)
	beego.SetStaticPath("/orange/Main/OwnerUser/css", `views/css`)
	beego.SetStaticPath("/orange/Main/OwnerUser/images", `views/images`)
	beego.SetStaticPath("/orange/Main/OwnerUser/js", `views/js`)
	beego.SetStaticPath("/orange/Main/OwnerUser/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Main/OwnerUser/b/js", `views/b/js`)
	beego.SetStaticPath("/orange/Teacher/ListenOverHtml/css", `views/css`)
	beego.SetStaticPath("/orange/Teacher/ListenOverHtml/images", `views/images`)
	beego.SetStaticPath("/orange/Teacher/ListenOverHtml/js", `views/js`)
	beego.SetStaticPath("/orange/Teacher/ListenOverHtml/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Teacher/ListenOverHtml/b/js", `views/b/js`)
	beego.SetStaticPath("/orange/Main/RegisteredLinefwtk/css", `views/css`)
	beego.SetStaticPath("/orange/Main/RegisteredLinefwtk/images", `views/images`)
	beego.SetStaticPath("/orange/Main/RegisteredLinefwtk/js", `views/js`)
	beego.SetStaticPath("/orange/Main/RegisteredLinefwtk/b/css", `views/b/css`)
	beego.SetStaticPath("/orange/Main/RegisteredLinefwtk/b/js", `views/b/js`)

	beego.SetStaticPath("/orange/Teacher/UserAskQuestion/b/fonts", "views/b/fonts")
	beego.SetStaticPath("/orange/Main/GetOnlineCourseBooking/views/images", "views/images")
	beego.SetStaticPath("/default.pdf", "views/default.pdf")
