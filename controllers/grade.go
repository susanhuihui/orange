...
func (c *GradeController) URLMapping() {
...
// @Param	body		body 	models.Grade	true		"body for Grade content"
...
// @router /GetGradeById/:id [get]
func (c *GradeController) GetOne() {
	idStr := c.Ctx.Input.Params[":id"]
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetGradeById(id)
	if err != nil {
...
// @Success 200 {object} models.Grade
// @Failure 403
// @router /GetAllGrade/:page/:size [get]
func (c *GradeController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllGrade(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @router /UpdateGradeById/:id [put]
func (c *GradeController) Put() {
	idStr := c.Ctx.Input.Params[":id"]
	id, _ := strconv.Atoi(idStr)
	v := models.Grade{Id: id}
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if err := models.UpdateGradeById(&v); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
...
func (c *GradeController) Delete() {
	idStr := c.Ctx.Input.Params[":id"]
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteGrade(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
