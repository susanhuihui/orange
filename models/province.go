...
type Province struct {
	...
	ProCode string `orm:"column(ProCode);size(50);null"`
	ProName string `orm:"column(ProName);size(50);null"`
}
...
// Id doesn't exist
func GetProvinceById(id int) (v *Province, err error) {
	o := orm.NewOrm()
	v = &Province{Id: id}
...
func DeleteProvince(id int) (err error) {
	o := orm.NewOrm()
	v := Province{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
